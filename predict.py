...
from cog import BasePredictor, Input, Path as PathCog
import json
import time
import torch
import argparse
...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        sf.write(output_path, audio_array, args.target_sample_rate)
        return PathCog(output_path)
